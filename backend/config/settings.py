...
class Settings(BaseSettings):
    ...
    warmup_delay_seconds: float = Field(default=4.0, alias="WARMUP_DELAY_SECONDS")
    duplicate_stop_streak: int = Field(default=30, alias="DUPLICATE_STOP_STREAK")
    page_delay_min_seconds: float = Field(default=6.0, alias="PAGE_DELAY_MIN_SECONDS")
    page_delay_max_seconds: float = Field(default=12.0, alias="PAGE_DELAY_MAX_SECONDS")
